...
def test_script(obj):
    ...
    dict_pvcorvlan = {'PVC_OR_VLAN_1':[PVC_OR_VLAN1_flag, PVC_OR_VLAN_1, Enable1],
                      'PVC_OR_VLAN_2':[PVC_OR_VLAN2_flag, PVC_OR_VLAN_2, Enable2], 
                      'PVC_OR_VLAN_3':[PVC_OR_VLAN3_flag, PVC_OR_VLAN_3, Enable3],
...
if __name__ == '__main__':
    ...
    dict_data= {"PVC_OR_VLAN_1":("PVC:0/61","1"),"Enable1":("0","2"),
        "PVC_OR_VLAN_2":("PVC:0/62","3"),"Enable2":("1","4")}
