...
def test_script(obj):
    ...
    Standby_MediaGatewayControler = obj.dict_data.get("Standby_MediaGatewayControler")[0]
    ...
    dict_voiceservice = {"VoiceProfile.1.X_CT-COM_ServerType":[1, "2"],
                         "Capabilities.SignalingProtocols":[0, "H.248"],
                         "VoiceProfile.1.X_CT-COM_H248.MediaGatewayControler":[1, MediaGatewayControler],
                         "VoiceProfile.1.X_CT-COM_H248.MediaGatewayControlerPort":[1, "2944"],
                         "VoiceProfile.1.X_CT-COM_H248.Standby-MediaGatewayControler":[1, Standby_MediaGatewayControler],
                         "VoiceProfile.1.X_CT-COM_H248.Standby-MediaGatewayControlerPort":[1, "2944"],
                         "VoiceProfile.1.X_CT-COM_H248.MediaGatewayPort":[1, "1944"],
                         ...
                         "VoiceProfile.1.X_CT-COM_H248.PhysicalTermIDPrefix":[1, PhysicalTermIDPrefix],
                         "VoiceProfile.1.X_CT-COM_H248.PhysicalTermIDAddLen":[1, PhysicalTermIDAddLen],
