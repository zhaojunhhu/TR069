...
def test_script(obj):
    ...
    X_CT_COM_LanInterface1 = "InternetGatewayDevice.LANDevice.1.LANEthernetInterfaceConfig.3,InternetGatewayDevice.LANDevice.1.LANEthernetInterfaceConfig.4,InternetGatewayDevice.LANDevice.1.WLANConfiguration.1"
    
    IPv6IPAddressOrigin = obj.dict_data.get("IPv6IPAddressOrigin")[0]
    IPv6PrefixOrigin    = obj.dict_data.get("IPv6PrefixOrigin")[0]
    
    
    IPv6PrefixMode = obj.dict_data.get("IPPrefixMode")[0]
    ...
    dict_wanpppconnection1_2 = {'Enable':[1, '1'],
                              ...
                              'X_CT-COM_IPv6PrefixDelegationEnabled':[0,"1"],
                              'X_CT-COM_MulticastVlan':[0, 'Null']}
...
if __name__ == '__main__':
    ...
    dict_data= {"PVC_OR_VLAN1":("PVC:0/65","1"),
                ...
                "IPv6PrefixModeOrigin":("PrefixDelegation","6"),
                "IPPrefixMode":("WANDelegated","7"),
                "IPv6PrefixModeAddr":("2001:1:2:3::/64","8"),
