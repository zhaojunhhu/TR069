...
def test_script(obj):
    ...
    # data传参
    DIP_Max = obj.dict_data.get("DIP_Max")[0]
    DIP_Min = obj.dict_data.get("DIP_Min")[0]
    DPORT_Max = obj.dict_data.get("DPORT_Max")[0]
    DPORT_Min = obj.dict_data.get("DPORT_Min")[0]
...
if __name__ == '__main__':
    ...
    dict_data= {"DIP_Min":("222.66.65.59","1"),"DIP_Max":("222.66.65.59","2"),
        "DPORT_Min":("6000","3"),"DPORT_Max":("6000","4"),
            "DSCPMarkValue":("4","5"),"M802_1_P_Value":("4","6"),
                "ClassQueue":("1","7")}
