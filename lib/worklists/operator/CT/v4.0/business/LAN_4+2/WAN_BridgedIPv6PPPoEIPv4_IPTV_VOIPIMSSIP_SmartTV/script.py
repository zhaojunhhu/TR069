...
def test_script(obj):
    ...
    X_CT_COM_LanInterface2 = obj.dict_data.get("X_CT_COM_LanInterface2")[0]
    ret, X_CT_COM_LanInterface2 = ParseLANName(X_CT_COM_LanInterface2)
    ...
    dict_wanpppconnection1_2 = {'Enable':[1, '1'],
                              ...
                              'Username':[1, Username], 
                              'Password':[1, Password],
                              'X_CT-COM_LanInterface':[1, X_CT_COM_LanInterface2],
                              'X_CT-COM_LanInterface-DHCPEnable':[0, 'Null'], 
                              'X_CT-COM_ServiceList':[1, "INTERNET"],
                              'X_CT-COM_IPMode':[1, '1'],
                              'X_CT-COM_IPv6IPAddressOrigin':[0,'Null'],
    ...
    # VOIP dict data
    dict_wanlinkconfig3 = {'X_CT-COM_Enable':[0, 'Null'],
                          'X_CT-COM_Mode':[PVC_OR_VLAN3_flag, '2'],
                          'X_CT-COM_VLANIDMark':[PVC_OR_VLAN3_flag, PVC_OR_VLAN3],
                          'X_CT-COM_802-1pMark':[1, '0']}
    
    dict_wanipconnection3 = {'Enable':[1, '1'],
                            'ConnectionType':[1, 'IP_Routed'], 
                            'Name':[0, 'Null'],
                            'NATEnabled':[0, 'Null'], 
                            ...
                            'X_CT-COM_ServiceList':[1, 'VOIP']}   
    
    dict_wanpppconnection3 = {}
    # voice 相关
    dict_voiceservice = {"VoiceProfile.1.X_CT-COM_ServerType":[1,'0'],
