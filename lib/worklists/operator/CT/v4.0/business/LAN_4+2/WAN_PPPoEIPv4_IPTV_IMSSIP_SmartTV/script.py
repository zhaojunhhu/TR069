...
import _IPV4WANSetUP
reload(_IPV4WANSetUP)
from _IPV4WANSetUP import IPV4WANSetUP
...
def test_script(obj):
    ...
    AccessMode1 = 'PPPoE'    # 用于双栈WAN， WAN接入模式,可选PPPoE_Bridge,PPPoE,DHCP,Static
    ...
    ret, ret_data = IPV4WANSetUP(obj, sn, WANEnable_Switch1, DeviceType,
                       AccessMode1, PVC_OR_VLAN1, dict_wanlinkconfig1,
                       dict_wanpppconnection1, dict_wanipconnection1,
                       change_account=0,
