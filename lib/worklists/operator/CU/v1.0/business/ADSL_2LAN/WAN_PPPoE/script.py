...
def test_script(obj):
    ...
    X_CU_LanInterface = obj.dict_data.get("X_CU_COM_LanInterface")[0]
    X_CU_ServiceList = obj.dict_data.get("X_CU_COM_ServiceList")[0]
    ...
    dict_wanpppconnection = {'Enable':[1, '1'],
                             ...
                             'Username':[1, Username], 
                             'Password':[1, Password],
                             'X_CU_LanInterface':[1, X_CU_LanInterface], 
...
if __name__ == '__main__':
    ...
    dict_data= {"PVC_OR_VLAN":("PVC:0/61","1"),
                "Username":("TW61","2"),"Password":("TW61","3"),
