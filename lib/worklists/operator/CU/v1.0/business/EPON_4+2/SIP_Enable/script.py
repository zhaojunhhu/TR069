...
def test_script(obj):
    ...
    dict_voiceservice = {"VoiceProfile.1.SIP.ProxyServer":[1, ProxyServer],
                         ...
                         "VoiceProfile.1.SIP.OutboundProxy":[0, "Null"],
                         "VoiceProfile.1.SIP.OutboundProxyPort":[0, "Null"],
                         ...
                         "VoiceProfile.1.SIP.X_CU_SecondaryOutboundProxyServer":[0, "Null"],
                         "VoiceProfile.1.SIP.X_CU_SecondaryOutboundProxyServerPort":[0, "Null"],
