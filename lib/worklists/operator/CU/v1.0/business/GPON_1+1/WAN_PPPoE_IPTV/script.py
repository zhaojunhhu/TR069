...
def test_script(obj):
    ...
    X_CU_COM_LanInterface1 = obj.dict_data.get("X_CU_COM_LanInterface1")[0]
    X_CU_COM_ServiceList1 = obj.dict_data.get("X_CU_COM_ServiceList1")[0]
    PVC_OR_VLAN2 = obj.dict_data.get("PVC_OR_VLAN2")[0]  # ADSL上行只关心PVC值,LAN和EPON上行则关心VLAN值
    X_CU_COM_MulticastVlan = obj.dict_data.get("X_CU_COM_MulticastVlan")[0] # 新增公共组播VLAN的下发
    ...
    ret, X_CU_COM_LanInterface1 = ParseLANName(X_CU_COM_LanInterface1)
    if ret == ERR_FAIL:
    ...
    dict_wanlinkconfig1 = {'X_CU_VLANEnabled':[1, '1'],
                          'X_CU_802_1p':['0','NULL'],
    ...
    dict_wanlinkconfig2 = {'X_CU_VLANEnabled':[1, '1'],
                          'X_CU_802_1p':['0','NULL'],
    ...
    dict_wanpppconnection1 = {'Enable':[1, '1'],
                              ...
                              'Username':[1, Username], 
                              'Password':[1, Password],
                              'X_CU_LanInterface':[1, X_CU_COM_LanInterface1],
                              'X_CU_ServiceList':[1, X_CU_COM_ServiceList1],
    ...
    # WANPPPConnection节点参数
    # 注意:X_CU_IPMode节点有些V4版本没有做,所以不能使能为1.实际贝曼工单也是没有下发的
    LAN1 = 'InternetGatewayDevice.LANDevice.1.LANEthernetInterfaceConfig.1'    # 绑字到LAN2
    
    if X_CU_COM_MulticastVlan == "":
        X_CU_COM_MulticastVlan_flag = 0
    else:
        X_CU_COM_MulticastVlan_flag = 1
    ...
    dict_wanpppconnection2 = {'Enable':[1, '1'],
                              ...
                              'Username':[0, 'Null'], 
                              'Password':[0, 'Null'],
                              'X_CU_LanInterface':[1, LAN1], 
                              'X_CU_ServiceList':[1, 'OTHER'],
                              'X_CU_LanInterface-DHCPEnable':[0, 'Null'], 
                              'X_CU_IPMode':[0, 'Null'],
                              'X_CU_MulticastVlan':[X_CU_COM_MulticastVlan_flag, X_CU_COM_MulticastVlan]}
