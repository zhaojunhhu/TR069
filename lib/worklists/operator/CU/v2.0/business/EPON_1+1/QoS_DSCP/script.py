...
def test_script(obj):
    ...
    # X_CU_Function.UplinkQoS.App.{i}.节点下的参数
    dict_app = {'AppName': [0, 'Null'],
                'ClassQueue': [0, 'Null']}

    # X_CU_Function.UplinkQoS.Classification.{i}.type.{i}.节点下的参数
