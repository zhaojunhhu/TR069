...
def test_script(obj):
    ...
    # data传参
    WPAEncryptionModes = obj.dict_data.get("WPAEncryptionModes")[0]
    PreSharedKey = obj.dict_data.get("PreSharedKey")[0]
    ...
    dict_root = {'X_CU_SSIDHide': [0, 'Null'],
                 'X_CU_RFBand': [0, 'Null'],
                 'X_CU_ChannelWidth': [0, 'Null'],
                 'X_CU_GuardInterval': [0, 'Null'],
                 'X_CU_RetryTimeout': [0, 'Null'],
                 'X_CU_Powerlevel': [0, 'Null'],
                 'X_CU_PowerValue': [0, 'Null'],
                 'X_CU_APModuleEnable': [0, 'Null'],
                 'X_CU_WPSKeyWord': [0, 'Null'],
                 'Enable': [1, '1'],
                 'Channel': [0, 'Null'],
                 'SSID': [0, 'Null'],
                 ...
                 'WPAEncryptionModes': [1, WPAEncryptionModes],
                 'WPAAuthenticationMode': [1, WPAAuthenticationMode],
    ...
    dict_PreSharedKey = {'PreSharedKey': [1, PreSharedKey],
                         'KeyPassphrase': [0, 'Null']}

    # 开始执行WLAN工单
    ret, ret_data = WLAN(obj, sn, Num, dict_root, dict_WEPKey, dict_PreSharedKey,
...
if __name__ == '__main__':
    ...
    dict_data = {"WPAEncryptionModes": ("TKIPEncryption", "1"),
