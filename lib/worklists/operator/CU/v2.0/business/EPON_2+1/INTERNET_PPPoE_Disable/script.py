...
def test_script(obj):
    ...
    X_CU_LanInterface = obj.dict_data.get("X_CU_LanInterface")[0]

    if X_CU_LanInterface == "":

        X_CU_LanInterface_flag = 0
    else:

        X_CU_LanInterface_flag = 1
    ...
    dict_wanpppconnection = {'Enable': [1, '1'],
                             ...
                             'Username': [0, 'Null'],
                             'Password': [0, 'Null'],
                             'X_CU_LanInterface': [X_CU_LanInterface_flag, X_CU_LanInterface],
...
if __name__ == '__main__':
    ...
    dict_data = {"PVC_OR_VLAN": ("65", "1"), "X_CU_LanInterface": "LAN1"}
