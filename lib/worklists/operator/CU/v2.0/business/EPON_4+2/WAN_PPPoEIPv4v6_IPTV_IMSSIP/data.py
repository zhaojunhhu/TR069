...
# 工单 描述
WORKLIST_DOC = """
功能描述：开通上网(IPv4/v6路由) + IPTV + VOIP(IMS SIP) 业务工单：

IPv4/v6为INTERNET模式，采用PPPoE认证；
...
| X_CU_LanInterface1 | LAN3,LAN4,WLAN1 | 绑定LAN端口,默认LAN3,LAN4,WLAN1 |
...
| X_CU_MulticastVlan | 166 | 公共组播VLAN(注意:如果此参数值为"null",则表示不下发组播VLAN节点.) |
...
WORKLIST_ARGS = {
    ...
    "Password": ("admin6", "3"),
    "X_CU_LanInterface1": ("LAN3,LAN4,WLAN1", "4"),
    ...
    "X_CU_SecondaryProxyServer": ("172.24.55.67", "26"),
    "X_CU_SecondaryProxyServerPort": ("5060", "27"),
    "X_CU_SecondaryRegistrarServer": ("172.24.55.67", "28"),
    "X_CU_SecondaryRegistrarServerPort": ("5060", "29"),
    "X_CU_SecondaryOutboundProxyServer": ("0.0.0.0", "30"),
    "X_CU_SecondaryOutboundProxyServerPort": ("5060", "31"),
    "AuthUserName1": ("55511021", "32"),
    "AuthPassword1": ("55511021", "33"),
    "URI1": ("55511021", "34"),
    "AuthUserName2": ("55511022", "35"),
    "AuthPassword2": ("55511022", "36"),
    "URI2": ("55511022", "37"),
}
