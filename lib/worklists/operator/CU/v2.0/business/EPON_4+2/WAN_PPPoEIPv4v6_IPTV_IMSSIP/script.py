...
def test_script(obj):
    ...
    X_CU_LanInterface1 = obj.dict_data.get("X_CU_LanInterface1")[0]

    # X_CU_ServiceList1 = obj.dict_data.get("X_CU_ServiceList1")[0]
    ret, X_CU_LanInterface1 = ParseLANName(X_CU_LanInterface1)
    ...
    X_CU_MulticastVlan = obj.dict_data.get("X_CU_MulticastVlan")[0]  # 新增公共组播VLAN的下发
    ...
    # INTERNET dict data
    dict_wanlinkconfig1 = {'X_CU_VLANEnabled': [PVC_OR_VLAN1_flag, '1'],
                           'X_CU_802_1p': [PVC_OR_VLAN1_flag, '0'],
                           'X_CU_VLAN': [PVC_OR_VLAN1_flag, PVC_OR_VLAN1]}
    ...
    dict_wanpppconnection1_1 = {'Enable': [1, '1'],
                                ...
                                'Username': [1, Username],
                                'Password': [1, Password],
                                'X_CU_LanInterface': [1, X_CU_LanInterface1],
                                'X_CU_LanInterface-DHCPEnable': [0, 'Null'],
                                'X_CU_ServiceList': [1, "INTERNET"],
                                'X_CU_IPMode': [1, '3'],
                                'X_CU_IPv6IPAddressOrigin': [1, IPv6IPAddressOrigin],
                                'X_CU_IPv6PrefixOrigin': [1, IPv6PrefixOrigin],
                                'X_CU_IPv6PrefixDelegationEnabled': [1, "1"],
                                'X_CU_MulticastVlan': [0, 'Null']}
    ...
    dict_wanlinkconfig2 = {'X_CU_VLANEnabled': [PVC_OR_VLAN2_flag, '1'],
                           'X_CU_802_1p': [PVC_OR_VLAN2_flag, '0'],
                           'X_CU_VLAN': [PVC_OR_VLAN2_flag, PVC_OR_VLAN2]}

    if X_CU_MulticastVlan == "":
        X_CU_MulticastVlan_flag = 0
    else:
        X_CU_MulticastVlan_flag = 1
    ...
    dict_wanpppconnection2 = {
        ...
        'Username': [0, 'Null'],
        'Password': [0, 'Null'],
        'X_CU_LanInterface': [1, LAN2],
        'X_CU_ServiceList': [1, 'OTHER'],
        'X_CU_LanInterface-DHCPEnable': [0, 'Null'],
        'X_CU_IPMode': [0, 'Null'],
        'X_CU_MulticastVlan': [X_CU_MulticastVlan_flag, X_CU_MulticastVlan],
        'Enable': [1, '1']}

    dict_wanipconnection2 = {}

    dict_root = {'IGMPSnoopingEnable': [1, '1'],
                 'ProxyEnable': [0, 'Null'],
                 'SnoopingEnable': [0, 'Null']}

    # VOIP dict data
    dict_wanlinkconfig3 = {'X_CU_VLANEnabled': [PVC_OR_VLAN3_flag, '1'],
                           'X_CU_802_1p': [PVC_OR_VLAN3_flag, '0'],
                           'X_CU_VLAN': [PVC_OR_VLAN3_flag, PVC_OR_VLAN3]}
    ...
    dict_wanipconnection3 = {'Enable': [0, '1'],
                             ...
                             'X_CU_ServiceList': [1, 'TR069,VOIP']}

    dict_wanpppconnection3 = {}
    # voice 相关
    dict_voiceservice = {"VoiceProfile.1.X_CU_ServerType": [1, '0'],
                         ...
                         "VoiceProfile.1.SIP.X_CU_802-1pMark": [0, "Null"],
...
if __name__ == '__main__':
    ...
    dict_data = {"PVC_OR_VLAN1": ("PVC:0/65", "1"),
                 ...
                 "X_CU_LanInterface1": ("LAN3,LAN4,WLAN1", "33"),
                 ...
                 "X_CU_Standby_ProxyServer": ("172.24.55.67", "25"),
                 "X_CU_Standby_ProxyServerPort": ("5060", "26"),
                 "X_CU_Standby_RegistrarServer": ("172.24.55.67", "27"),
                 "X_CU_Standby_RegistrarServerPort": ("5060", "28"),
                 "X_CU_Standby_OutboundProxy": ("0.0.0.0", "29"),
                 "X_CU_Standby_OutboundProxyPort": ("5060", "30"),
