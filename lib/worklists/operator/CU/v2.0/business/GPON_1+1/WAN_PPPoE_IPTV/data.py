...
功能描述：生成一个开通PPPoE上网和IPTV的Other桥工单.
    ...
    | X_CU_LanInterface1 | LAN1 | 绑定LAN端口,默认LAN1 |
    | X_CU_ServiceList1  | INTERNET | WAN连接的服务模式,即X_CU_ServiceList节点值,默认INTERNET |
...
WORKLIST_ARGS = {
    ...
    "Username": ("TW65", "2"),
    "Password": ("TW65", "3"),
    "X_CU_LanInterface1": ("LAN1", "4"),
    "X_CU_ServiceList1": ("INTERNET", "5"),
    "PVC_OR_VLAN2": ("PVC:0/66", "6"),
    "X_CU_MulticastVlan": ("166", "7"),
