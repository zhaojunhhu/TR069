        ...
        try:
            ...
            if WAN_Flag == 0:
                ...
                if AccessMode == 'PPPoE' or AccessMode == 'PPPoE_Bridged':
                    ...
                    tmp_X_CU_COM_LanInterface =  dict_wanpppconnection['X_CU_LanInterface'][1]
                    tmp_X_CU_COM_ServiceList = dict_wanpppconnection['X_CU_ServiceList'][1]
                    ...
                    # GCW 20130418 应该只区分是路由还是桥接
                    tmp_ConnectionType = "IP_Routed"
                    tmp_X_CU_COM_LanInterface = dict_wanipconnection['X_CU_LanInterface'][1]
                    tmp_X_CU_COM_ServiceList = dict_wanipconnection['X_CU_ServiceList'][1]
                    ...
                    if (ret3_2 == ERR_SUCCESS):
                        ...
                        for j in xrange(3):
                            ...
                            if 'ConnectionType' in ret_data3_2['ParameterList'][j]['Name'].split("."):
                                ...
                                if ret_data3_2['ParameterList'][j]['Value'] == tmp_X_CU_COM_LanInterface:
                                    #WAN_Flag_1 = 1
                                    pass
                                else:
                                    WAN_Flag_1 = 0
                                ...
                                if ret_data3_2['ParameterList'][j]['Value'] == tmp_X_CU_COM_ServiceList:
                                    #WAN_Flag_1 = 1
                                    pass
                                else:
                                    WAN_Flag_1 = 0
                        ...
                        if WAN_Flag_1 == 0:
                            ...
                            #        if ret_data3_2['ParameterList'][j]['Value'] != tmp_X_CU_COM_ServiceList:
                            #            tmp_X_CU_COM_ServiceList = 'INTERNET,OTHER'
                            ...
                            for j in tmp_values:
                                if tmp_values[j][0] == 1:
                                    ...
                                    if (j == 'X_CU_ServiceList'):
                                        para_list6.append(dict(Name=tmp_path, Value=tmp_X_CU_COM_ServiceList))
                                    else:
            ...
            #第七步：调用修改联通维护密码,目前密码固定为nE7jA%5m
