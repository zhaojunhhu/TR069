...
def WANSetUP(obj, sn, WANEnable_Switch, DeviceType,
    ...
    for nwf in [1]:
        try:
            ...
            if AccessMode == 'PPPoE' or AccessMode == 'DHCP' or AccessMode == 'Static' or AccessMode == 'PPPoE_Bridged':
                ...
                for i in xrange(len(ret_data_root['ParameterList'])):
                    ...
                    if AccessMode == 'PPPoE' or AccessMode == 'PPPoE_Bridged':
                        ...
                        X_CU_COM_ServiceList = dict_wanpppconnection['X_CU_ServiceList'][1]
                        ...
                        X_CU_COM_ServiceList = dict_wanipconnection['X_CU_ServiceList'][1]
            ...
            if WAN_Flag == 1 or WAN_Flag == 2:
                ...
                if (("tr069" in X_CU_COM_ServiceList) or
                    ("TR069" in X_CU_COM_ServiceList)):
