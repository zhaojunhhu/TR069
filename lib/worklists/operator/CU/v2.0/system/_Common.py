...
#  module name: _Common
#  function: ChangeAccount_CU,修改联通维护帐号密码
...
def ParseLANName(LanName):
    ...
    for i in LanName.split(","):
        ...
        elif i.upper() == 'WLAN3' or i.upper() == 'InternetGatewayDevice.LANDevice.1.WLANConfiguration.3'.upper():
...
def update_username_password_to_acs(sn, Username="", Password="", ConnectionRequestUsername="",
